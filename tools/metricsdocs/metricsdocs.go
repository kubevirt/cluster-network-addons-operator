...
const (
	title      = "# Cluster Network Addons Operator metrics\n"
	note       = "> This file is auto generated by metricsdocs, run `make generate-doc` in order to update it.\n\n"
	background = "This document aims to help users that are not familiar with metrics exposed by the Cluster Network Addons Operator.\n" +
		"All metrics documented here are auto-generated by the utility tool `tools/metricsdocs` and reflects exactly what is being exposed.\n"

	KVSpecificMetrics = "## Cluster Network Addons Operator Metrics List\n"

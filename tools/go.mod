module github.com/kubevirt/cluster-network-addons-operator/tools
...
replace github.com/openshift/api => github.com/openshift/api v0.0.0-20220315184754-d7c10d0b647e
...
require (
	...
	github.com/kubevirt/monitoring/pkg/metrics/parser v0.0.0-20240721182102-d28f2aa73295
...
// This must be in sync with CNAO's own dependencies
replace (
	github.com/machadovilaca/operator-observability => github.com/machadovilaca/operator-observability v0.0.19-0.20240326121036-9f2e5a31675f
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring => github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.64.1
	sigs.k8s.io/controller-runtime => sigs.k8s.io/controller-runtime v0.14.6
)

replace sigs.k8s.io/controller-tools => sigs.k8s.io/controller-tools v0.6.0

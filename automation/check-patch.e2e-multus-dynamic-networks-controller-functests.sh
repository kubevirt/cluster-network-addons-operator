...
main() {
    ...
    COMPONENT="multus-dynamic-networks-controller" source automation/components-functests.setup.sh

    trap teardown EXIT

    echo "Run multus-dynamic-networks-controller functional tests"

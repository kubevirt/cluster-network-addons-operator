...
require (
	...
	github.com/openshift/cluster-network-operator v0.0.0-20240802075630-68b81c74e40d
	github.com/openshift/custom-resource-status v0.0.0-00010101000000-000000000000

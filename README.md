...
```shell
kubectl apply -f https://raw.githubusercontent.com/kubevirt/cluster-network-addons-operator/release-0.42/manifests/cluster-network-addons/0.42.2/namespace.yaml
kubectl apply -f https://raw.githubusercontent.com/kubevirt/cluster-network-addons-operator/release-0.42/manifests/cluster-network-addons/0.42.2/network-addons-config.crd.yaml
kubectl apply -f https://raw.githubusercontent.com/kubevirt/cluster-network-addons-operator/release-0.42/manifests/cluster-network-addons/0.42.2/operator.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/kubevirt/cluster-network-addons-operator/release-0.42/manifests/cluster-network-addons/0.42.2/network-addons-config-example.cr.yaml
```

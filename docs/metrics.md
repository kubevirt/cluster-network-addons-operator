...
DEPRECATED: Total count of duplicate KubeMacPool MAC addresses. This metric monitors VM MACs instead of running VMI MACs and will be removed in the next minor release. Use KubeMacPool's native VMI collision detection instead.. Type: Gauge.

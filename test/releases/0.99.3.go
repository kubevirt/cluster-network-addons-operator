	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:205a61e62a5d0090cbc7147c7e24f678878e5e04326b59b0b44a73639838a618",
			},
			{
				ParentName: "kubemacpool-mac-controller-manager",
				ParentKind: "Deployment",
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "manager",
				Image:      "ghcr.io/kubevirt/ipam-controller@sha256:103232b8807cf1abe88de60733add2e0cc4e28320483b81579395a345d12530d",
			},
		},

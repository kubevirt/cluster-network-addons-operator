	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:943165a3acddc307dc44d02a8aa77c9f5e921966e1bcd93cfc0aaa4f158509e2",
			},
			{
				ParentName: "kubemacpool-mac-controller-manager",
				ParentKind: "Deployment",
			...
			},
			{
				...
				ParentKind: "DaemonSet",
				Name:       "ovs-cni-plugin",
				Image:      "quay.io/kubevirt/ovs-cni-plugin@sha256:746dbc2ff16b24bab6d9c442dedbf0900acdb2e28c89dc7b452a2b01a648e126",
			},
			{
				ParentName: "ovs-cni-amd64",
				ParentKind: "DaemonSet",

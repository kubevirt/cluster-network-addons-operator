	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:a2b3caeafc8a6d9c015f762a9c14adaba983943b8c3d7768a8c78a781abc7a91",
			},
			{
			...
			},
			{
				...
				Image:      "quay.io/nmstate/kubernetes-nmstate-handler@sha256:c60cd62eb2aec8793c9a5287767b22ca5654d31420708a46095582825cd2266f",
			},
			{

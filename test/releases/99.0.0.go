	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:71a31e89e8126a387d0b62ae51a96d4d2e58a9aae130641b42a188fa07ba369c",
			},
			{
				ParentName: "kubemacpool-mac-controller-manager",
				ParentKind: "Deployment",
			...
			},
			{
				...
				ParentKind: "DaemonSet",
				Name:       "ovs-cni-plugin",
				Image:      "quay.io/kubevirt/ovs-cni-plugin@sha256:5e47be7d56698727a9e8fc5a218762c4367111109864d037956e76aa8e39e1db",
			},
			{
				ParentName: "ovs-cni-amd64",
				ParentKind: "DaemonSet",

	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:611ea4ada64478c57b63d6f6738f49928e063545761070e3d164bc82a71733d9",
			},
			{
				ParentName: "kubemacpool-mac-controller-manager",
				ParentKind: "Deployment",
			...
			},
			{
				...
				ParentKind: "DaemonSet",
				Name:       "ovs-cni-plugin",
				Image:      "quay.io/kubevirt/ovs-cni-plugin@sha256:eb24b23aa2fa1a76c09c5d7302bca29a382808f61eaacca07c3a78dafaffbc91",
			},
			{
				ParentName: "ovs-cni-amd64",
				ParentKind: "DaemonSet",

	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:3ab5ef69e48a3eb866aff174d3e806f17a0b044cc597ae1150d535386833b29a",
			},
			{
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "manager",
				Image:      "ghcr.io/kubevirt/ipam-controller@sha256:83f03d3185ee5b27489ae4cb876bf64c9a0b9a910724deae8c341bfae0531152",
			},
		},

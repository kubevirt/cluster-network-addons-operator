	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:71cbca3a2c777680eb91a317a13a616aa76c31a3def4f3e3e43043ed11248b49",
			},
			{
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "manager",
				Image:      "ghcr.io/kubevirt/ipam-controller@sha256:b7d382c91dd401886664eedcb2799731ff06728e2e59d7e7277e4ea00266fde9",
			},
		},

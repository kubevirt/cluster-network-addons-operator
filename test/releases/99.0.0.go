	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:916f5969437ece5a3f49742e668e93f8412ae6b06600d1b63a6c023e1035de4a",
			},
			{
				ParentName: "kubemacpool-mac-controller-manager",
				ParentKind: "Deployment",
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "manager",
				Image:      "ghcr.io/kubevirt/ipam-controller@sha256:200dc58f2a2bec3ca26077f67cdf53c678666597147d0dae931cbef00f86943a",
			},
		},

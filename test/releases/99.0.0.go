	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				ParentKind: "DaemonSet",
				Name:       "bridge-marker",
				Image:      "quay.io/kubevirt/bridge-marker@sha256:99d0fbd707deaf2136968aaa34862b54c73c9e5e963dc44140e726cf9ad41b58",
			},
			{
			...
			},
			{
				...
				Image:      "quay.io/qinqon/kubernetes-nmstate-handler@sha256:8b44c9888f35eb88a505ce26f13eb5c602d6dd5375205b3b078adad8d11666b3",
			},
			{

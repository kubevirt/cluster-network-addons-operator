	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				ParentKind: "DaemonSet",
				Name:       "bridge-marker",
				Image:      "quay.io/kubevirt/bridge-marker@sha256:8c40e9e78167472c6840a74eefa00ab001279e9c1630908e5c652893f1d9fd44",
			},
			{
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "status-monitor",
				Image:      "ghcr.io/kubevirt/kubesecondarydns@sha256:c79a41a65884c03406cb993005d6258c2c33215d4d55299aaeacda444e27280f",
			},
			{
				ParentName: "secondary-dns",
				ParentKind: "Deployment",
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "manager",
				Image:      "ghcr.io/kubevirt/ipam-controller@sha256:597468879e6e7623c60a8268895544aa018e29ee9db2f27297974ce169ae2faa",
			},
			{
				ParentName: "passt-binding-cni",
				ParentKind: "DaemonSet",
				Name:       "installer",
				Image:      "ghcr.io/kubevirt/passt-binding-cni@sha256:cb85339a8cd62d17daa985f91f3f70998fe55e24d140434d733629cdb0c97ce9",
			},
		},

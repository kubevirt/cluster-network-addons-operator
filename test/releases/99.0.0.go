	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:d009c4829af2a3b46f70d54687075aa401d216c27fd965f24c0c5b7b3b7d92c7",
			},
			{
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "manager",
				Image:      "ghcr.io/kubevirt/ipam-controller@sha256:1c761c8da9ba7d14f4eee8d566061ca452d0241d223c97116d2f36325fd47863",
			},
		},

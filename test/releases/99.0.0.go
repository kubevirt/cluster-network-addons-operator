	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:2fa3b45b91f4026a047c44be9b3253f484dd5ea3951983c37450714d866c386a",
			},
			{
				ParentName: "kubemacpool-mac-controller-manager",
				ParentKind: "Deployment",
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "manager",
				Image:      "ghcr.io/kubevirt/ipam-controller@sha256:95c3135cc3e3016d5624e058729dde5a596b9f126e54db1ad277e160866d8353",
			},
		},

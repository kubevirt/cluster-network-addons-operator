	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "manager",
				Image:      "ghcr.io/kubevirt/ipam-controller@sha256:1da836bd2de809675b94bdc175de052829b1c42b576eea91902b0b4be0811cff",
			},
			{
				ParentName: "passt-binding-cni",
				ParentKind: "DaemonSet",
				Name:       "installer",
				Image:      "ghcr.io/kubevirt/passt-binding-cni@sha256:27e3bf8fd0324f80c78a18d10d0cdac8b58537a23ffa82f9ab8354bb9fff3d20",
			},
		},

	...
	release := Release{
		...
		Containers: []cnao.Container{
			...
			},
			{
				...
				Name:       "manager",
				Image:      "quay.io/kubevirt/kubemacpool@sha256:476fde21f76efd0fb44af3fc660e145911dff7951620e146683bb3d8e0e834d3",
			},
			{
				ParentName: "kubemacpool-mac-controller-manager",
				ParentKind: "Deployment",
			...
			},
			{
				...
				ParentKind: "Deployment",
				Name:       "status-monitor",
				Image:      "ghcr.io/kubevirt/kubesecondarydns@sha256:fbe94c3aeb2ba2c4ce85b506f6fbd4f03fb83a8fcb4f4121bba6ea76da3fbffe",
			},
			{
				ParentName: "secondary-dns",
				ParentKind: "Deployment",
